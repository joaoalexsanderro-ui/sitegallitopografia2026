...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0c1c3c]! backdrop-blur-xl" style={{ backgroundColor: '#0c1c3c' }}>
      ...
      {menuOpen && (
        <div className="animate-in slide-in-from-top-2 border-t border-white/10 bg-[#0c1c3c] px-4 pb-6 pt-3 md:hidden">
