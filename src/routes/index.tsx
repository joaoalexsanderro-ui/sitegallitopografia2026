...
function TeamSection() {
  const team = [
    { name: "Fabiano Marcos Galli", role: "CEO & Fundador", photo: "https://rmetppilvfrxosvxzhgj.supabase.co/storage/v1/object/public/message-attachments/df909724-d1f2-4377-897e-dfbbd9509455/1778162397719_p4ptvs_equipe_Galli__1_.png" },
